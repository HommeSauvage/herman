...
import { useAgentStore } from "../views/main/lib/agent-store.js";
import type { AgentEvent } from "./agent-protocol.js";
import type { Message, Tab } from "./rpc.js";
...
beforeEach(() => {
  ...
  mock.module("../bun/agent-bridge.js", () => ({
...
async function createManager() {
  const { AgentProcessManager } = await import("../bun/agent-process-manager.js");
